...
* Core object: `TikhonovFamily(A, L, b, d, ...)` representing the entire family
  [
  x_\lambda = \arg\min_x |Ax - b|_2^2 + \lambda |Lx - d|_2^2
  ]
  for all (\lambda > 0).
...
* GSVD-based implementation (via [`easygsvd`](https://github.com/jlindbloom/easygsvd)):
  ...
  * Efficient computation of (|Ax_\lambda - b|*2^2), (|Lx*\lambda - d|_2^2), and their derivatives.
